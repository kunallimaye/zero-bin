...
impl Checkpoint {
    ...
    pub fn get_checkpoint(&self, block_number: u64) -> u64 {
        match self {
            Self::BlockNumberNegativeOffset(offset) if block_number > *offset => block_number - offset,
    ...
    match source {
        ...
        BlockSource::ZeroBinRpc { rpc_url } => {
            ...
            let fetch_prover_input_request = FetchProverInputRequest {
                ...
                block_number,
                checkpoint_block_number: checkpoint_method.unwrap_or_default().get_checkpoint(block_number),
            };
